...
void BlowfishDecipher(unsigned int *xl, unsigned int *xr)
{
    int i;
...
void BlowfishEncipher(unsigned int *xl, unsigned int *xr)
{
    int i;
    unsigned int Xl, Xr, temp;
...
void BlowfishInit(char *key, int keybytes)
{
    int i, j, k;
...
void DecryptString(char *dest, char *src, char *key)
{
    int i;
    unsigned int l, r;
    char *s, *d;
...
void EncryptString(char *dest, char *src, char *key)
{
    int i;
    unsigned int l, r;
    unsigned char *s, *d;
