...
int is_number(register char *str)
{
    while (*str == ' ')
        str++;
    if (*str == '-')
...
int build_color_new(char *color, char *dest)
{
    int  colnum;
    char *tmpstr = color;
    char *tmpstr1;
...
int set_color(char *color, char *string)
{
    char *tmpstr;
    char *tmpstr1;
...
void set_colstr(int setnum, int colnum, char *colstr)
{
    char tmpbuf[256];
    char *dest;
    char *c;
...
char *get_color_name(int number)
{
...
void get_colors(int number, char *buffer)
{
    strcpy(buffer,"");
...
void fix_attr(char *colbuf, int lowcolor, int highcolor, int curcolor)
{
    int  i;
    char tmpbuf[mybufsize];
...
void fix_color(char *colbuf, int lowcolor, int highcolor, int curcolor)
{
    int  i;
    char tmpbuf[mybufsize];
...
void print_userhost(char *color, char *user, char *host, int parens)
{
    char buf1[256];
    char buf2[256];
    char buf3[256];
