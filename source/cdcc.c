 ...
 ************************************************************************/
void Cdcc(char *command, char *args, char *subargs)
{
    char *word=(char *) 0;
    char *tmpstr;
    int  len=0;
 ...
 ***********************************************************************/
static void listmcommand(char *line)
{
    ShowPacks(line);
}
 ...
 * Sets CDCC limit                                                     *
 ***********************************************************************/
static void limitmcommand(char *line)
{
    int number;
    int isnumber=1;
    char *word;
 ...
 ***********************************************************************/
static void idlemcommand(char *line)
{
 ...
 ***********************************************************************/
static void autogetmcommand(char *line)
{
 ...
 ***********************************************************************/
static void securemcommand(char *line)
{
...
***********************************************************************/
static void emcommand(char *line)
{
...
***********************************************************************/
static void mmcommand(char *line)
{
...
***********************************************************************/
static void channelsmcommand(char *line)
{
    char *channels;
 ...
 ***********************************************************************/
static void ptimemcommand(char *line)
{
 ...
 ***********************************************************************/
static void ntimemcommand(char *line)
{
 ...
 ***********************************************************************/
static void longstatusmcommand(char *line)
{
 ...
 ***********************************************************************/
static void overwritemcommand(char *line)
{
 ...
 ***********************************************************************/
static void statusmcommand(char *line)
{
 ...
 ***********************************************************************/
static void statsmcommand(char *line)
{
 ...
 ***********************************************************************/
static void warningmcommand(char *line)
{
 ...
 ***********************************************************************/
static void verbosemcommand(char *line)
{
 ...
 ***********************************************************************/
static void uldirmcommand(char *line)
{
    char *newdir;
 ...
 ***********************************************************************/
static void dldirmcommand(char *line)
{
    char *newdir;
    char *fullname=(char *) 0;
    char tmpbuf[mybufsize/4];
...
static char dccstatus(int flags)
{
 ...
 ***********************************************************************/
static void showdccsmcommand(int type)
{
    int   fills;
    int   count=1,i,j;
...
***********************************************************************/
static void closemcommand(char *line)
{
    char *word;
...
***********************************************************************/
static void close2mcommand(char *blah, char *line)
{
    int  count=0;
    int  packcount=0;
...
***********************************************************************/
static void doffermcommand(char *line)
{
    char *word;
...
***********************************************************************/
static void doffer2mcommand(char *blah, char *line)
{
    int   packcount=0;
    Files *tmp2;
    Files *next;
...
static void formatstats(char *buffer, int cdccstuff)
{
    char byteschar='k';
    char tmpbuf[mybufsize/4];
    double mult=1.0;
...
static int CheckCdccChannel(char *channels, char *chanlist)
{
    int found=0;
    int minus=0;
    char *tmpstr1;
...
static void sendplist(char *text)
{
    char *msg;
    char *channel;
...
***********************************************************************/
static void plistmcommand(char *line)
{
    int   current=0;
    char  *tmpchan;
...
***********************************************************************/
static void noticemcommand(char *line)
{
    int   current=0;
    char  *tmpchan;
    ChannelList *chan=server_list[curr_scr_win->server].chan_list;
 ...
 ***********************************************************************/
#ifdef EXTRAS
static void renamepackmcommand(char *line)
{
    int  number;
    int  i;
    char *pack;
...
***********************************************************************/
#ifndef LITE
static void loadmcommand(char *line)
{
    int   count=0;
    int   lineno=0;
    char  *file;
...
***********************************************************************/
static void savemcommand(char *line)
{
    int   count=0;
 ...
 ***********************************************************************/
static void requestmcommand(char *line)
{
    if (line && *line) {
...
***********************************************************************/
static void offermcommand(char *line)
{
    char *speed;
    char *desc;
...
*                 And puts in Files Linked List                       *
***********************************************************************/
static void offer2mcommand(char *blah, char *line)
{
    if (line && *line) {
...
***********************************************************************/
static void offer3mcommand(char *blah, char *line)
{
...
***********************************************************************/
static void offer4mcommand(char *blah, char *line)
{
...
***********************************************************************/
static void AddToOfferList(char *speed, char *desc)
{
    int   totalfiles=0;
    float totalbytes=0;
    char  byteschar;
...
***********************************************************************/
static void sendmcommand(char *line)
{
...
*                Files Linked list                                    *
***********************************************************************/
static void send2mcommand(char *blah, char *line)
{
    if (line && *line) {
        if (AddFiles2List(line))
...
*                Files Linked list                                    *
***********************************************************************/
static void send3mcommand(char *blah, char *line)
{
    int  count;
    int  queue=0;
    int  queueret;
...
***********************************************************************/
#ifdef EXTRAS
static void fsendmcommand(char *line)
{
    char *x = line, *comma = NULL;
...
*                 Files Linked list                                    *
***********************************************************************/
static void fsend2mcommand(char *blah, char *line)
{
    if (line && *line) {
        if (AddFiles2List(line))
...
*                 Files Linked list                                    *
***********************************************************************/
static void fsend3mcommand(char *blah, char *line)
{
    int  count;
    char byteschar;
    char *nick=(char *) 0;
...
***********************************************************************/
static void resendmcommand(char *line)
{
    char *x = line, *comma = NULL;
...
*                  Files Linked list                                  *
***********************************************************************/
static void resend2mcommand(char *blah, char *line)
{
    if (line && *line) {
        if (AddFiles2List(line))
...
**************************************************************************/
static void resend3mcommand(char *blah, char *line)
{
    int  count=0;
    char byteschar;
    char *nick=(char *) 0;
...
***********************************************************************/
#ifndef LITE
static void psendmcommand(char *line)
{
    char *x = line, *comma = NULL;
...
*                Pack Linked list                                     *
***********************************************************************/
static void psend2mcommand(char *blah, char *line)
{
    if (line && *line)
...
***********************************************************************/
static void psend3mcommand(char *blah, char *line)
{
    int  packcount;
    char *nick;
    char *tmpstr;
...
***********************************************************************/ 
static int SeedFiles(char *line, int error)
{
    int  i=0;
    int  size=0;
    int  count=0;
...
***********************************************************************/
static void AddFileToList(char *path, char *file, double size)
{
    Files *new;
    Files *tmp;
...
***********************************************************************/
static int AddFiles2List(char *line)
{
    int   count=0;
    char  *file=(char *) 0;
    char  tmpbuf[mybufsize*2];
...
**********************************************************************/
static void ShowPacks(char *args)
{
    int   packcount=1;
    char  byteschar;
    char  *word=(char *) 0;
...
************************************************************************/
static float GetSize(char *path, char *file)
{
    char  tmpbuf[mybufsize/2];
...
***********************************************************************/
static void getmcommand(char *line)
{
    char *word;
...
***********************************************************************/
static void get2mcommand(char *data, char *line)
{
    int  count = 0;
    int  mode;
    char *tmp = NULL;
...
void CheckCdcc(char *nick, char *args, char *to, int msg)
{
    int  level=0;
    char *command=(char *) 0;
#ifdef WANTANSI
...
static void helpcommand(char *from, char *args)
{
...
static void versioncommand(char *from, char *args)
{
    if (CTCPCloaking) return;
...
static void sendlist(char *text)
{
    send_to_server("%s",text);
}

/* Check what listing type they want. */
static void listcommand(char *from, char *args)
{
    int   count=0;
    int   multdelay;
    int   packcount=1;
...
/* List files in queue */
static void queuecommand(char *from, char *args)
{
    int i=1;
    int cnt=0;
    char *tmpstr=(char *) 0;
...
static void sendcommand(char *from, char *args, int resend, int level)
{
    int   packcount=1;
    int   totalfiles=0;
    int   sent=0;
...
void CheckAutoGet(char *nick, char *userhost, char *file, char *type)
{
    char tmpbuf[mybufsize/4];
...
***********************************************************************/
void RemoveFromQueue(int removed)
{
...
***********************************************************************/
void CdccQueueNickChange(char *oldnick, char *newnick)
{
    FileQueue *tmp=queuelist;
