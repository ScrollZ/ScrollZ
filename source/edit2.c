...
void ChanWallOp(char *command, char *args, char *subargs)
{
    int  server = 0;
...
void MegaMode(char *args, int type)
{
    char *argument;
    char *channel;
...
/* MegaDeops channel */
void MegaDeop(char *command, char *args, char *subargs)
{
    MegaMode(args,4);
}

/* MegaDehalfop channl */
void MegaDehalfop(char *command, char *args, char *subargs)
{
    MegaMode(args,2);
}

/* MegaReops channel */
void MegaReop(char *command, char *args, char *subargs)
{
    MegaMode(args,6);
}

/* MassOp channel */
void MassOp(char *command, char *args, char *subargs)
{
    MegaMode(args,5);
}

/* MassHalfop channl */
void MassHalfop(char *command, char *args, char *subargs)
{
    MegaMode(args,3);
}
...
#ifdef EXTRAS
/* MegaVoice channel */
void MegaVoice(char *command, char *args, char *subargs)
{
    MegaMode(args,1);
}

/* MegaDeVoice channel */
void MegaDeVoice(char *command, char *args, char *subargs)
{
    MegaMode(args,0);
}
#endif

void DoDops(char *chops, char *channel, int type)
{
    int  send = 0;
    int  count = 0;
...
void NewUser(char *command, char *args, char *subargs)
{
    char *tmp;
...
void ReconnectServer(char *command, char *args, char *subargs)
{
    int port;
...
void ReconnectOnKill(int servernum)
{
    int flag=1;
    int change=0;
...
void Kick(char *command, char *args, char *subargs)
{
    char *channel;
    char *tmpnick=(char *) 0;
    char *comment=(char *) 0;
...
void Ban(char *command, char *args, char *subargs)
{
    char *channel = (char *) 0;
    char *tmpnick;
    void (*func)();
...
void BanKick(char *command, char *args, char *subargs)
{
#ifdef EXTRAS
    int unbantime = 6;
#endif
...
void Op(char *command, char *args, char *subargs)
{
    char flag;
    int  count = 0;
    int  usage = 0;
...
void Invite(char *command, char *args, char *subargs)
{
    char *tmpnick;
...
void Leave(char *command, char *args, char *subargs)
{
    char *p;
    char *comment = NULL;
...
void ModeClear(char *command, char *args, char *subargs)
{
    char *channel=(char *) 0;
    char tmpbuf[mybufsize/2];
    ChannelList *chan;
...
void ChannelScan(char *command, char *args, char *subargs)
{
#ifdef NEWCSCAN
    int  count = 0;
    int  width = 0;
...
void ListFriends(char *command, char *args, char *subargs)
{
    DontHold=0;
...
void ListFriendsPage(char *line)
{
    int  count=3;
    int  filter;
#ifdef WANTANSI
...
void ListFriendsKey(char *stuff, char *line)
{
...
void ListAutoBanKicks(char *command, char *args, char *subargs)
{
    DontHold=0;
    if (args && *args) malloc_strcpy(&tmpbuflist,args);
    else malloc_strcpy(&tmpbuflist,"*");
...
void BuildShit(struct autobankicks *shitentry, char *buffer)
{
...
/* This waits for key press */
void ListABKsKey(char *stuff, char *line)
{
    if (line && (*line=='q' || *line=='Q' || *line=='E')) {
        if (*line=='E') say("%d out of %d entries matched your filter",listcount,
                            countall);
...
void Topic(char *command, char *args, char *subargs)
{
    int iscrypted;
    char *channel;
    char *tmparg;
...
void FServer(char *command, char *args, char *subargs)
{
...
void Cycle(char *command, char *args, char *subargs)
{
    char *tmpchannel = NULL;
    char tmpbuf[mybufsize / 4];
    ChannelList *chan;
...
void ScrollZSave(char *command, char *args, char *subargs)
{
    int  ulistcount;
    int  slistcount;
    int  nlistcount;
...
struct friends *CheckUsers(char *userhost, char *channels)
{
    struct friends *tmpfriend;
...
struct autobankicks *CheckABKs(char *userhost, char *channel)
{
    struct autobankicks *tmpabk;
...
void DirLM(char *command, char *args, char *subargs)
{
    int  msg=1;
    char *tmparg;
...
void AddFriend(char *command, char *args, char *subargs)
{
    int quiet=0;
    char *tmpnick=(char *) 0;
    char *tmpchan=(char *) 0;
...
int CheckPrivs(char *privs, char *buffer)
{
    int  i=0;
...
void AddFriend2List(char *nick, char *userhost, char *buffer)
{
    int  i=0;
    int  domsg=1;
    int  number=1;
...
void AddAutoBanKick(char *command, char *args, char *subargs)
{
    char *tmpnick;
    char *tmpchan;
    char *tmpshit;
...
int CheckShit(char *shit, char *buffer)
{
    int i = 0;
    char *tmpshit = (char *) 0;
...
void AddBK2List(char *userhost, char *shit, char *reason)
{
    int i=0;
    char *tmpchan=(char *) 0;
    char tmpbuf1[mybufsize/4];
...
void ShowBans(char *command, char *args, char *subargs)
{
    int  count=0;
    char *channel=(char *) 0;
    char tmpbuf[mybufsize/4];
...
void RemoveFriend(char *command, char *args, char *subargs)
{
    char *tmpnick=(char *) 0;
    char tmpbuf[mybufsize/4];
    void (*func)();
...
void RemoveFriendFromList(char *userhost)
{
    int  found=0;
    int  filter;
    int  count=0;
...
void RemoveAutoBanKick(char *command, char *args, char *subargs)
{
    char *tmpnick=(char *) 0;
    char tmpbuf[mybufsize/4];
    void (*func)();
...
void RemoveAutoBanKickFromList(char *userhost)
{
    int found=0;
    int count=0;
    int filter;
...
void Version(char *command, char *args, char *subargs)
{
    char *target=NULL;
...
/* Unbans nick */
void Unban(char *command, char *args, char *subargs)
{
    void (*func)();
    char *tmpnick=(char *) 0;
    char *channel;
...
/* Handles bans */
void OnBans(char **args, int exception)
{
    int  server;
    char *chan;
    char *daban;
...
void CdBan(char *command, char *args, char *subargs)
{
    char *tmpchan = NULL;
    char *banbuf = NULL;
    char tmpbuf2[mybufsize / 4];
...
/* Unignores user */
void NoIgnore(char *command, char *args, char *subargs)
{
    char *tmpnick;
    char tmpbuf[mybufsize/4];
...
static char *CeleTimeFormat(time_t timediff)
{
    int timesec=0;
    int timemin=0;
    int timehour=0;
...
void SetAway(char *command, char *args, char *subargs)
{
    int  modify = 1;
    int  showit = 1;
    int  oldserver;
...
void SetBack(char *command, char *args, char *subargs)
{
...
void SetBack2(char *stuff, char *line)
{
    char reply=' ';
...
void SetBackDelete(char *stuff, char *line)
{
    int  done=1;
    int  showit=1;
    int  modify=1;
...
void AddWord(char *command, char *args, char *subargs)
{
    int  add = 0;
    int  ban = 0;
    int  bantime = 0;
...
void RemoveWord(char *command, char *args, char *subargs)
{
    char *channels;
    char *tmpstr;
...
void ListWords(char *command, char *args, char *subargs)
{
    int count = 1;
    char tmpbuf[mybufsize / 2];
    struct words *tmpword;
...
struct words *CheckLine(char *channels, char *line)
{
    char *curword;
    char *tmpline;
...
void AddNick2List(char *nick, int server)
{
    int count;
    int curserv=server;
...
int AddSplitter(char *nick, char *channel, char *servers)
{
    int    print=0;
    struct list *tmplist;
...
void Check4Join(char *userhost, char *servername, char *channel)
{
    struct wholeftstr *wholeft;
...
void WhoLeft(char *command, char *args, char *subargs)
{
    int  i;
    int  len;
    int  ctlen;
...
void FilterKick(char *command, char *args, char *subargs)
{
    char *channel;
    char *filter;
    char *mynick;
...
void DoBans(char *command, char *args, char *subargs)
{
    int  count=0;
    int  max=get_int_var(MAX_MODES_VAR);
    char *channel=(char *) 0;
