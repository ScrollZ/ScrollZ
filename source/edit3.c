...
char *subargs;
{
    ...
    put_it(" ,$Ù'À*³$;,            _,Ú*y˜$S$*',g$$7Ù'^À7'  i$³i `À$S$ $S$ $,    ,Ú*$$$*¿");
    put_it(",$* ,$Ú_'Ù*³*,      ,*$*Ù'`'À*$' ,gS$7'*'  ,,*Ù'`Ù*   $S$ $S$ $$b.,dS$$Ù'`$$");
    put_it("* ,dSS$$Ú,_ 'Ù*s*s*Ù'`,Úgi$$$ip¿,dS$Y$b,`'`,Úgi$ip¿,  $S$ $S$ À$$$$$Ù'_¿$,`;;");
    put_it("` `$$SSSS$$$Ú,_`*_,¿$d$$7''^^Y$$dS$  `4$bÚd$$7'^`4$$b¿$S$ $S$$Ú,_ _,¿$$$$$, **");
