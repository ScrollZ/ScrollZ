...
static void BlowfishEncipher(unsigned int *xl, unsigned int *xr)
{
    int i;
...
static void BlowfishDecipher(unsigned int *xl, unsigned int *xr)
{
    int i;
    unsigned int Xl, Xr, temp;
...
static void BlowfishInit(char *key, int keybytes, int oldkey)
{
    int i, j, k, cnt;
...
int EncryptString(char *dest, char *src, char *key, int bufsize, int szenc, int type)
{
    int i;
    int oldk = 0;
    unsigned int l, r;
...
int DecryptString(char *dest, char *src, char *key, int bufsize, int szenc)
{
    int i;
    int oldk = 0;
    unsigned int l, r;
